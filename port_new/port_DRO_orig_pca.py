...
from utils import createproblem_portLP_lr, get_n_processes, pca, safe_solve, save_run_metadata
...
def port_experiments(r_input,T,N_init,synthetic_returns,r_start):
    try:
        ...
        for t in range(T):
            ...
            # the refit and include it in DRO's total_iteration below.
            ...
            if t % interval == 0 or ((t-1) % interval == 0) or (t in t_list) :
                ...
                # solve DRO problem
                    DRO_problem, DRO_x, DRO_s, DRO_tau, DRO_lmbda, DRO_data, DRO_eps, DRO_w = createproblem_portLP_lr(num_dat, m, pca_A, pca_b)
