...
def port_experiments(r_input,K,T,N_init,dateval,r_start):
    ...
    for t in range(T):
        ...
        if t % interval == 0 or ((t-1) % interval == 0) :
            ...
            # (ignore_dpp=True, solver=cp.GUROBI, verbose=False, gurobi_params = {'TimeLimit': 2000})
...
if __name__ == '__main__':
    ...
    #eps_init = [0.007,0.006,0.005,0.0045,0.004,0.003,0.002,0.0015]
    eps_init = [0.006,0.0058,0.0055,0.0053,0.0051,0.005,0.0045,0.0015,0.0012,0.001,0.0008]
