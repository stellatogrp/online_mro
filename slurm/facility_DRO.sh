...
python facility/facility_DRO.py --foldername /scratch/gpfs/iywang/mro_results/facility/ --R 5 --T 2001 --fixed_time 1500 --interval 100 --Q 300 --K 15 --N_init 5 --r_start 0  
#--n 5 --m 25
