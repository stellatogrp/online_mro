...
#SBATCH -o /scratch/gpfs/BSTELLATO/iywang/low_rank/online_mro/portfolio_test_p1_%A_.txt
...
# python port_new/port.py --foldername port_new/results/p1/2/ --R 10 --T 2001 --fixed_time 2001 --interval 1 --Q 500 --K 15 --N_init 5 --r_start 0 --m 50
...
# python port_new/port_DRO_orig.py --foldername port_new/results/p1/1/ --R 10 --T 2001 --fixed_time 1500 --interval 1 --Q 500 --K 15 --N_init 5 --r_start 0 --m 50

python port_new/port_DRO.py --foldername port_new/results/p1/1/ --R 10 --T 2001 --fixed_time 2001 --interval 1 --Q 500 --K 2000 --N_init 5 --r_start 0 --m 50
