...
# python port_new/port_orig_pca.py --foldername port_new/results/orig/p1/pca3/ --R 5 --T 2001 --fixed_time 2001 --interval 10 --Q 1000 --K 15 --N_init 5 --r_start 0 --m 150 --lr_var_frac 0.95 --pca_interval 50
...
# python port_new/port_DRO_orig_pca.py --foldername port_new/results/orig/p1/pca4/ --R 1 --T 2001 --interval 10 --interval_SAA 10 --N_init 5 --r_start 0 --m 150 --lr_var_frac 0.9 --pca_interval 100
