...
# python port_new/port_orig.py --foldername port_new/results/orig/p1/1/ --R 5 --T 2001 --fixed_time 2001 --interval 10 --Q 500 --K 15 --N_init 5 --r_start 5 --m 150

# python port_new/port.py --foldername port_new/results/new/p1/1/ --R 10 --T 2001 --fixed_time 2001 --interval 1 --Q 500 --K 15 --N_init 5 --r_start 0 --m 150

python port_new/port_DRO.py --foldername port_new/results/new/p1/1/ --R 2 --T 2001 --interval 1 --N_init 5 --r_start 0 --m 150

# python port_new/port_DRO_orig_p2.py --foldername port_new/results/orig/p2/1/ --R 5 --T 2001 --interval 10 --interval_SAA 10 --N_init 5 --r_start 5 --m 150
