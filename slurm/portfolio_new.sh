...
# python port_new/port_orig.py --foldername port_new/results/orig/p1/4/ --R 2 --T 2001 --fixed_time 2001 --interval 10 --Q 1000 --K 15 --N_init 5 --r_start 0 --m 150

# python port_new/port.py --foldername port_new/results/new/p1/4/ --R 2 --T 2001 --fixed_time 2001 --interval 1 --Q 1000 --K 15 --N_init 5 --r_start 8 --m 150
