...
# python port_new/port.py --foldername port_new/results/p1/1/ --R 10 --T 2001 --fixed_time 1500 --interval 1 --Q 500 --K 15 --N_init 5 --r_start 0 --m 50

# python port_new/port_p2.py --foldername port_new/results/p2/1/ --R 10 --T 2001 --fixed_time 1500 --interval 1 --Q 500 --K 15 --N_init 5 --r_start 0 --m 50
