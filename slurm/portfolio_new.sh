...
python port_new/port_orig_pca.py --foldername port_new/results/orig/p1/pca2/ --R 5 --T 2001 --fixed_time 2001 --interval 10 --Q 1000 --K 15 --N_init 5 --r_start 5 --m 150 --lr_var_frac 0.9
...
# python port_new/port_DRO_orig_pca.py --foldername port_new/results/orig/p1/pca2/ --R 2 --T 2001 --interval 10 --interval_SAA 10 --N_init 5 --r_start 8 --m 150 --lr_var_frac 0.9
