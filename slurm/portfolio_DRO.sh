...
# python portfolio_time/portMIP_DRO.py --foldername /scratch/gpfs/iywang/mro_results/portfolio/ --R 5 --T 3001 --interval 100  --interval_SAA 100 --r_start 15
...
python portfolio_time/portMIP_DRO.py --foldername /scratch/gpfs/iywang/mro_results/portfolio/ --R 10 --T 10001 --interval 20000 --r_start 10 --interval_SAA 100
