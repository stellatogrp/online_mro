...
python portfolio_time/portMIP_DRO.py --foldername /scratch/gpfs/iywang/mro_results/portfolio_60/ --R 5 --T 1001 --interval 50  --interval_SAA 50  --N_init 5 --r_start 15 --m 50
