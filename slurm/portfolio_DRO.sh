...
python portfolio_time/portMIP_DRO.py --foldername /scratch/gpfs/iywang/mro_results/portfolio_50/ --R 5 --T 2001 --interval 50  --interval_SAA 50  --N_init 5 --r_start 25 --m 50
