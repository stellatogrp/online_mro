...
python facility/facility.py --foldername /scratch/gpfs/iywang/mro_results/facility/1050/ --R 4 --T 501 --fixed_time 500 --interval 20 --Q 100 --K 15 --N_init 5 --r_start 0  --n 10 --m 50
