...
python portfolio_time/portMIP.py --foldername /scratch/gpfs/iywang/mro_results/portfolio/ --R 1 --T 1001 --fixed_time 2500 --interval 100 --Q 500 --K 15 --N_init 5 --r_start 0
