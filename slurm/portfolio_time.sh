...
python portfolio_time/portMIP.py --foldername portfolio_time/results/1/ --R 5 --T 2001 --fixed_time 2001 --interval 50 --Q 500 --K 15 --N_init 5 --r_start 0 --m 50 --rmse_mult 1

# python portfolio_time/portMIP_DRO.py --foldername portfolio_time/results/1/ --R 5 --T 2001 --interval 100  --interval_SAA 100  --N_init 5 --r_start 0 --m 50 --rmse_mult 1
