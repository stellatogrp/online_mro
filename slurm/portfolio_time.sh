...
# python portfolio_time/portMIP.py --foldername /scratch/gpfs/iywang/mro_results/portfolio/ --R 5 --T 3001 --fixed_time 2500 --interval 120 --interval_online 120 --Q 1000 --K 15

# python portfolio_time/portMIP.py --foldername /scratch/gpfs/iywang/mro_results/portfolio/ --R 5 --T 2001 --fixed_time 1500 --interval 100 --interval_online 100 --Q 500 --K 15
