...
# python portfolio_time/portMIP.py --foldername /scratch/gpfs/iywang/mro_results/portfolio/ --R 20 --T 1001 --fixed_time 800 --interval 50 --Q 300 --K 15 --N_init 5 --r_start 40
